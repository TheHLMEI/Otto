...
// ottoipc typedefs
#define COMMON_PDU_ATTRIBUTES \
	uint8_t pdu_type;         \
	uint8_t opcode;           \
	char name[NAMLEN + 1];    \
	uint8_t option;
#define JOBLNK_PDU_ATTRIBUTES \
	int16_t id;               \
	int16_t level;            \
	int16_t box;              \
	int16_t head;             \
...
#define JOBDEF_PDU_ATTRIBUTES     \
	...
	char loopmax;                 \
	char loopsgn;
#define JOBEXT_PDU_ATTRIBUTES  \
	char new_name[NAMLEN + 1]; \
	time_t start;              \
	time_t finish;
#define JOBSTT_PDU_ATTRIBUTES \
	char expr_fail;           \
	char status;              \
	char on_autohold;         \
	char on_noexec;           \
